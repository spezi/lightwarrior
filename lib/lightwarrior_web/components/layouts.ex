  ...
  def left_top_menue(assigns) do
    ~H"""
      ...
      <div id="left_top_menue" class="tabs tabs-lift">
          <input :if={ @side != "uniform" } type="radio" name="left_top_menue_tabs" class="tab" aria-label={"stripe instances (#{length(Lightwarrior.State.get(:instances))})"} checked="checked" />
